...
//   onSave: (subject: SubjectConfig) => void;
// }

// export function EditSubjectModal({ isOpen, onOpenChange, subject, allFaculty, onSave }: EditSubjectModalProps) {
...
//           <DialogDescription>Fill in the details for the subject below.</DialogDescription>
//         </DialogHeader>
...
//                       <p className="text-sm text-muted-foreground">Select faculty who can teach this subject.</p>
//                     </div>
//                     <div className="space-y-2 rounded-md border p-4 max-h-48 overflow-y-auto">
//                       {allFaculty.length > 0 ? allFaculty.map((faculty) => (
//                         <FormField
//                           key={faculty.id}
//                           control={form.control}
//                           name="facultyIds"
...
//                                         : field.onChange(field.value?.filter((value) => value !== faculty.id));
//                                     }}
//                                   />
//                                 </FormControl>
//                                 <FormLabel className="font-normal">{faculty.name}</FormLabel>
//                               </FormItem>
//                             );
//                           }}
//                         />
//                       )) : <p className="text-sm text-muted-foreground">No faculty available. Add faculty in the 'Faculty' tab first.</p>}
//                     </div>
//                     <FormMessage />
//                   </FormItem>
//                 )}
...
//           <Button type="submit" onClick={form.handleSubmit(onSubmit)}>Save Subject</Button>
//         </DialogFooter>
//       </DialogContent>
//     </Dialog>
//   );
...
export function EditSubjectModal({
  ...
  }, [subject, isOpen, form, form.reset]);
  ...
  const onSubmit = async (data: SubjectFormValues) => {
    ...
    try {
      const payload = {
        ...
        facultyIds: data.facultyIds || [],
        isSpecial: false, // Default value, can be extended if needed
      };
      if (subject) {
        await axios.put(
          `${
